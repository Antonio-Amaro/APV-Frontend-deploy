            ...
            {pacientes.length ?
                ...
                (
                    <>
                        ...
                        <p className="text-xl mt-5 mb-10 text-center">Comienza agregando pacientes <span className="text-indigo-600 font-semibold">y aparecerán en este lugar</span></p>
                    </>
                )}
        </>
    )
